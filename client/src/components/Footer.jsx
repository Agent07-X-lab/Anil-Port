...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/anil-sahu-476001361/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "#", label: "Instagram" },
    { icon: <Youtube size={18} />, href: "#", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/Agent07-X-lab", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "sahuanil4908@gmail.com", href: "mailto:sahuanil4908@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 9574757357", href: "tel:+919574757357" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">ANIL</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Cybersecurity enthusiast & developer creating secure and meaningful experiences.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Anil. All rights reserved.</p>
            </div>
