...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { Engineer } from 'anil.dev';",
    "",
    "const developer = new Engineer({",
    "  name: 'Anil Kumar Sahu',",
    "  stack: ['Cybersecurity', 'Node.js', 'React', 'Python'],",
    "  focus: 'Cybersecurity & Full-Stack Web Development',",
    "  status: 'Seeking internship or entry-level roles'",
    "});",
    "",
  ...
  const achievements = [
    ...
    { number: "10+", label: "Projects Built", icon: <TrendingUp className="h-3 w-3" /> },
    { number: "8.2", label: "GPA", icon: <Award className="h-3 w-3" /> },
    { number: "2+", label: "Cyber Simulations", icon: <Zap className="h-3 w-3" /> }
  ];
        ...
        <motion.div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20" initial="hidden" animate={isInView ? "visible" : "hidden"} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.25, delayChildren: 0.5 } } }}>
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <span className="block text-foreground">I'm Anil Kumar</span>
            ...
            <motion.p className="text-lg sm:text-xl text-muted-foreground mt-6 leading-relaxed max-w-2xl" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              I build <span className="text-primary font-semibold">secure web applications</span> and analyze digital threats. Specializing in Node.js, Express, and cybersecurity simulations for modern enterprises.
            </motion.p>
            ...
            <motion.div className="mt-6 text-center lg:text-left" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <div className="text-sm text-muted-foreground">
                🚀 <span className="text-primary font-semibold">Available Immediately</span> for Cybersecurity and Full-Stack roles
              </div>
            </motion.div>
          </div>
                        ...
                        <div 
                          ...
                          className={`
                            ...
                            ${line.includes("import") ? "text-purple-400 font-semibold" : 
                              ...
                              line.includes("Engineer") ? "text-emerald-400 font-semibold" :
