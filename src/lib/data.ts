...
export const experiences = [
    {
        category: 'Education',
        items: [
            { title: 'B.Tech at PME College', date: '2021-2025', description: 'Pursuing a degree in Computer Science, focusing on software development and design principles.' },
        ],
    },
    {
        ...
        items: [
            ...
            { title: 'UI/UX Design Fundamentals', date: '2022', description: 'Gained foundational knowledge in user interface and user experience design.' },
            { title: 'SQL Database Management', date: '2022', description: 'Learned advanced SQL queries and database administration.' },
        ],
    },
    {
        ...
        items: [
            ...
            { title: 'College Tech Society Member', date: '2021-Present', description: 'An active member of the college technology society, organizing and participating in events.' },
        ],
    },
];
