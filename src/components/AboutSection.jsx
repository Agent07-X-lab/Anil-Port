...
export const AboutSection = () => {
  ...
  const achievements = [
    { number: "2+", label: "Projects", icon: <Briefcase className="h-5 w-5" />, suffix: "" },
    { number: "8.2", label: "GPA", icon: <Target className="h-5 w-5" />, suffix: "" },
    { number: "2+", label: "Simulations", icon: <Calendar className="h-5 w-5" />, suffix: "" },
    { number: "5+", label: "Certs", icon: <User className="h-5 w-5" />, suffix: "" }
  ];

  const techStack = [
    { category: "Frontend", items: ["React", "JavaScript", "HTML5", "CSS3"] },
    { category: "Backend", items: ["Node.js", "Express.js", "Socket.io", "Python", "C++"] },
    { category: "Cybersecurity", items: ["Log Analysis", "OWASP", "Network Security", "Linux"] }
  ];
  ...
  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/Agent07-X-lab" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/anil-sahu-476001361/" },
    { icon: <Twitter className="h-5 w-5" />, href: "#" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:sahuanil4908@gmail.com" }
  ];

  const tabContent = {
    personal: "Passionate about cybersecurity and full-stack development. I enjoy analyzing digital threats, building secure web applications, and continuously learning new technologies to stay ahead of the curve.",
    professional: "A B.Tech student in Computer Science (GPA: 8.2) specializing in cybersecurity and web development. I've completed rigorous simulations with Deloitte and Tata, gaining practical experience in threat identification and network security.",
    approach: "I focus on defense-in-depth principles while building applications. Clean code, robust security practices (OWASP), and a proactive approach to vulnerability assessment are at the core of my methodology."
  };
  ...
  const handleDownload = () => {
    ...
    link.href = '/projects/anil_kumar_sahu.pdf'; // Must be in public folder
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/anil-avatar.png" alt="Anil Kumar Sahu" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Anil Kumar Sahu</h2>
                    <p className="text-primary text-base sm:text-lg font-semibold mb-3 sm:mb-4">Cybersecurity & Full Stack Developer</p>
