...
const projects = [
  {
    id: 1,
    title: "Anonymous Hacker Chat Terminal",
    category: "Real-time Communication",
    description: "Built a fully anonymous real-time chat app over Socket.io WebSockets, supporting concurrent sessions with sub-100ms message delivery and zero persistent user-data storage.",
    image: "/projects/project1.png",
    video: "",
    tags: ["Node.js", "Express.js", "Socket.io", "HTML5", "CSS3"],
    demoUrl: "https://chat-app-frontend-gamma-seven.vercel.app/",
    githubUrl: "https://github.com/Agent07-Xlab/anonymous-chat-realtime",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: ["Anonymous sessions", "Real-time delivery", "Zero data storage"]
  },
  {
    id: 2,
    title: "Lofi Music Web Application",
    category: "Web Application",
    description: "Developed a high-fidelity music platform with dynamic ambient-environment controls and real-time theme switching, optimising UX for productivity-focused use cases.",
    image: "/projects/project2.png",
    video: "",
    tags: ["JavaScript", "HTML5", "CSS3", "Web Audio API"],
    demoUrl: "https://lofi-wine.vercel.app/",
    githubUrl: "https://github.com/Agent07-X-lab/Lofi",
    featured: true,
    accentColor: "from-purple-500 to-indigo-600",
    status: "Live",
    highlights: ["High-fidelity audio", "Ambient controls", "Theme switching"]
  },
  {
    id: 3,
    title: "Dentflow AI",
    category: "Healthcare SaaS",
    description: "Intelligent dental appointment & patient management system with conversational AI voice agent, seamless 3-step booking, Clerk-powered auth & payments, real-time admin dashboard, and clean email automation.",
    image: "/projects/project3.png",
    video: "",
    tags: ["TypeScript", "React", "Clerk", "AI", "Payments"],
    demoUrl: "#",
    githubUrl: "https://github.com/Agent07-X-lab/dentflow-ai",
    featured: false,
    accentColor: "from-blue-500 to-cyan-600",
    status: "Development",
    highlights: ["Conversational AI agent", "Clerk Authentication", "Admin dashboard"]
  },
  {
    id: 4,
    title: "Real-time Object Detection",
    category: "Artificial Intelligence",
    description: "A cutting-edge web application that leverages YOLOv8's state-of-the-art deep learning architecture to detect and classify objects in real-time. Processes images, videos, and live webcam feeds.",
    image: "/projects/project4.png",
    video: "",
    tags: ["TypeScript", "React", "YOLOv8", "Deep Learning"],
    demoUrl: "#",
    githubUrl: "https://github.com/Agent07-X-lab/Real-time-object-detection",
    featured: true,
    accentColor: "from-amber-500 to-orange-600",
    status: "Development",
    highlights: ["YOLOv8 Architecture", "Real-time Processing", "Webcam Integration"]
  },
  {
    id: 5,
    title: "BloomeeTunes",
    category: "Web Application",
    description: "A cross-platform music application designed to bring you ad-free tunes from various sources, providing a seamless and immersive listening experience.",
    image: "/projects/project5.png",
    video: "",
    tags: ["JavaScript", "React", "Audio Streaming"],
    demoUrl: "#",
    githubUrl: "https://github.com/Agent07-X-lab/BloomeeTunes",
    featured: false,
    accentColor: "from-rose-500 to-pink-600",
    status: "Live",
    highlights: ["Ad-free playback", "Cross-platform", "Seamless streaming"]
  }
];
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/Agent07-X-lab"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
